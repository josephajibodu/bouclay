...
trait HasTeams
{
    ...
    public function toTeamPermissions(Team $team): TeamPermissions
    {
        ...
        return new TeamPermissions(
            ...
            canViewPlans: $has(PermissionName::PlansView) || $has(PermissionName::PlansManage),
            canManagePlans: $has(PermissionName::PlansManage),
            ...
            canViewEntitlements: $has(PermissionName::EntitlementsView) || $has(PermissionName::EntitlementsManage),
            canManageEntitlements: $has(PermissionName::EntitlementsManage),
            canViewDiscounts: $has(PermissionName::DiscountsView) || $has(PermissionName::DiscountsManage),
            canManageDiscounts: $has(PermissionName::DiscountsManage),
