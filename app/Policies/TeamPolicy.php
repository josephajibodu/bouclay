...
class TeamPolicy
{
    ...
    /**
     * Determine whether the user can view the team's invoices.
     */
    ...
    /**
     * Determine whether the user can create and manage invoices.
     */
    public function manageInvoices(User $user, Team $team): bool
    {
